...
# ------------------------
STORAGES = {
{%- if devxhub_python.use_whitenoise == 'y' and devxhub_python.cloud_provider == 'None' %}
    "default": {
...
COMPRESS_URL = STATIC_URL{%-if devxhub_python.use_whitenoise == 'y' or devxhub_python.cloud_provider == 'None' %}  # noqa: F405
{%- endif %}
{%- if devxhub_python.use_whitenoise == 'y' %}
