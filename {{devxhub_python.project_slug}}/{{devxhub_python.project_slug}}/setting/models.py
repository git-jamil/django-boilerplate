...
from {{ devxhub_python.project_slug }}.models import BaseModel
from {{ devxhub_python.project_slug }}.utils.constants import DATE_FORMAT_CHOICES, CURRENCY_CHOICES, TIMEZONES, TIME_FORMAT_CHOICES
