...
timezones_file_path = os.path.join(settings.BASE_DIR, '{{ devxhub_python.project_slug }}', 'assets', 'timezones.json')
...
currencies_file_path = os.path.join(settings.BASE_DIR, '{{ devxhub_python.project_slug }}', 'assets', 'countries.json')
